...
@Component({
  selector: 'app-front-booking-theme-five',
  templateUrl: './front-booking-theme-five.component.html',
  styleUrls: ['./front-booking-theme-five.component.scss'],
  providers: [DatePipe]
})
export class FrontBookingThemeFiveComponent implements OnInit {
  selectedTheme:any = '1';
